...
import ro.fortsoft.log2j.converter.ConverterRegistry;
...
public class Log2j {
	...
	public Log2j setSkipLines(int skipLines) {
		this.skipLines = skipLines;
		
		return this;
	}

	public Log2j map(Class<?> entityClass) {
	...
	public Log2j setEntityHandlers(Set<EntityHandler<?>> entityHandlers) {
		this.entityHandlers = entityHandlers;
		
		return this;
	}
	
	public Log2j addEntityHandler(EntityHandler<?> entityHandler) {
	 ...
	 * @return
	 */
	public Log2j registerConverter(Converter<?> converter) {
	...
	/**
     * Process each line of the log and call an entity handler if that line can be mapped to an entity.
     *
	...
	private void onLogLine(int lineNumber, String lineText) throws Exception {
